...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/users/generate-pin', [UserController::class, 'generateNonExistingPin']);
    ...
    Route::put('/users/{id}/admin/update-password', [UserController::class, 'adminUpdatePassword'])->where('id', '[0-9]+');
    Route::put('/users/{id}/admin/update-pin', [UserController::class, 'adminUpdatePin'])->where('id', '[0-9]+');
